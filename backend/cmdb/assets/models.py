...
class IDC(models.Model):
    ...
    def __str__(self):
        return f"{self.name}機房 {self.floor}F"
...
class Asset(models.Model):
    ...
    rack = models.ForeignKey(
        to="Rack", verbose_name="機櫃", related_name="asset", blank=True, null=True, on_delete=models.CASCADE
    )
    # node
    ...
    def __str__(self):
        return f"{self.get_device_type_id_display()} {self.name}"
...
class StorageDisk(models.Model):
    ...
    storage = models.ForeignKey(
        "Storage", verbose_name="存儲設備", related_name="storagedisk", on_delete=models.CASCADE
    )
    ...
    def __str__(self):
        return f"{self.storage} {self.slot} {self.capacity}"
...
class StorageCtl(models.Model):
    ...
    storage = models.ForeignKey("Storage", verbose_name="存儲設備", related_name="storagectl", on_delete=models.CASCADE)
...
class StorageNic(models.Model):
    ...
    ctl = models.ForeignKey("StorageCtl", verbose_name="控制器", related_name="storagenic", on_delete=models.CASCADE)

    def __str__(self):
        return f"{self.ctl} {self.name}"
