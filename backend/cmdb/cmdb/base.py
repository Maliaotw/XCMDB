...
MIDDLEWARE = [
    ...
    "common.middleware.RequestLoggingMiddleware",  # API 請求日誌
...
REST_FRAMEWORK = {
    ...
    "DEFAULT_AUTHENTICATION_CLASSES": (
        ...
        "authentication.backends.api.JWTAuthentication",
    ),
...
LOGGING = {
    ...
    "formatters": {
        "normal": {"format": "[%(levelname)s] %(asctime)s | %(name)s:%(lineno)d | %(message)s"},
