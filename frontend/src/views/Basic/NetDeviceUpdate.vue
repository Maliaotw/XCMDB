<template>
    ...
    <div>
        ...
        <el-page-header @back="gopack" content="網路設備" style="background: white;padding-top: 20px;padding-bottom: 20px;margin-bottom: 20px">
        </el-page-header>
...
<script>
    ...
    export default {
        ...
        ,
        created() {
            getNetDeviceDtail(this.$route.params.id)
                    .then((res) => {
                        console.log(res)
                        this.form = res.data
